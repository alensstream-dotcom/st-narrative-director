...
const cast=object({name:text,aliases:array(text),gender:{type:'string',enum:['female','male','unknown']},is_subject:boolean,outfit:text,position:text,fixed_facts:array(fact)});
const scene=object({
