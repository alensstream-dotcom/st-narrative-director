  ...
  async analyze(input, signal, onEarlyScene) {
    ...
    if(streamingAuto){
      ...
      requestInput={
        ...
        PREVIOUS_CONTEXT:{recent:String(input.PREVIOUS_CONTEXT?.recent||'').slice(-140),states:(input.PREVIOUS_CONTEXT?.states||[]).slice(-1),outfits:(input.PREVIOUS_CONTEXT?.outfits||[]).slice(-2)},
